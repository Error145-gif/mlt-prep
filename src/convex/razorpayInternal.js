...
exports.createSubscription = (0, server_1.internalMutation)({
    args: {
    ...
    handler: function (ctx, args) { return __awaiter(void 0, void 0, void 0, function () {
        var userId, startDate, endDate, existingSubscription, subscriptionId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, ctx.db.patch(existingSubscription._id, {
                ...
                case 2:
                    ...
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, ctx.db.insert("subscriptions", {
                        userId: userId,
                        planName: args.planName,
                        amount: args.amount,
                        startDate: startDate,
