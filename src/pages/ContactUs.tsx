        ...
        >
          ...
          <Card className="glass-card border-white/20 backdrop-blur-xl bg-white/10">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                <svg className="h-6 w-6 text-pink-400 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-white/70 mb-2">
                    Stay updated with the latest news, tips, and study materials on our official Instagram page:
                  </p>
                  <a 
                  ...
                  <p className="text-white/60 text-sm mt-2">
                    Get daily motivation, exam updates, and connect with our growing community of MLT aspirants.
                  </p>
                </div>
              </div>
