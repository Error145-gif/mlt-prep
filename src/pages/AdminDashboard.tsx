          ...
          {isMenuOpen && (
            ...
            >
              <div className="flex flex-col p-4 space-y-2">
                ...
                <button onClick={() => { navigate("/admin/library"); setIsMenuOpen(false); }} className="text-left px-4 py-2 rounded-lg text-white hover:bg-white/10">📚 Library Management</button>
                ...
                <button onClick={() => { navigate("/admin/reported-errors"); setIsMenuOpen(false); }} className="text-left px-4 py-2 rounded-lg text-white hover:bg-white/10 font-bold">
                  ⚠️ Reported Errors
                </button>
              </div>
            </motion.div>
