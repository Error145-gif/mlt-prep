...
export default function SubscriptionPlans() {
  ...
  const plans = [
    ...
    },
    {
      ...
      action: () => handleSubscribe("monthly", 117, "Monthly Plan", 30),
    ...
    },
    {
      ...
      action: () => handleSubscribe("4months", 471, "4 Months Plan", 120),
    ...
    },
    {
      ...
      action: () => handleSubscribe("yearly", 707, "Yearly Plan", 365),
